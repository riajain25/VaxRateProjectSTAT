...
data_train_withcitycounty = data_train
...
write_csv(x = data_train_withcitycounty, file = "Desktop/stat471/stat-471-fall-2021/finalproject/data/clean/data_trainwithcitycounty.csv")
