...
rf_fit = randomForest(Series_Complete_18PlusPop_Pct ~ ., mtry =11, data = data_train, importance = TRUE)
...
oob_errors_rf %>% ggplot(aes(x= ntree, y = oob_err, colour=factor(m))) + geom_line() + theme_bw()
